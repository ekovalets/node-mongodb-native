...
## [7.1.0](https://github.com/ekovalets/node-mongodb-native/compare/v7.0.0...v7.1.0) (2026-01-30)


### Features

* **NODE-5393:** aws4 no longer required for AWS authentication ([#4824](https://github.com/ekovalets/node-mongodb-native/issues/4824)) ([0f46db8](https://github.com/ekovalets/node-mongodb-native/commit/0f46db8a6135178dbe2806bb1289870e8973f382))
* **NODE-7121:** prevent connection churn on backpressure errors when establishing connections ([#4800](https://github.com/ekovalets/node-mongodb-native/issues/4800)) ([4cb2b87](https://github.com/ekovalets/node-mongodb-native/commit/4cb2b87537536461dc2f5cd9f0a8a56ad193cb13))
* **NODE-7122:** exponential backoff between retries in convenient transaction API ([#4765](https://github.com/ekovalets/node-mongodb-native/issues/4765)) ([e70fdc9](https://github.com/ekovalets/node-mongodb-native/commit/e70fdc981dc2bdc0d3c12515b2eecc214d8f3ce4))
* **NODE-7304:** remove usages in src of promisify ([#4799](https://github.com/ekovalets/node-mongodb-native/issues/4799)) ([761b9bf](https://github.com/ekovalets/node-mongodb-native/commit/761b9bfab8dfc8e3e7e311731d7a5cda1285bc6c))
* **NODE-7306:** Replace global process with import node:process ([#4820](https://github.com/ekovalets/node-mongodb-native/issues/4820)) ([cc503cb](https://github.com/ekovalets/node-mongodb-native/commit/cc503cb9810e2dbde0862fd8c8daa8ee613ef7b1))
* **NODE-7310:** Replace process.arch with os.arch() ([#4823](https://github.com/ekovalets/node-mongodb-native/issues/4823)) ([f0af829](https://github.com/ekovalets/node-mongodb-native/commit/f0af829f1a6fdf8cc0b070a327682f6299b747f1))
* **NODE-7311:** Replace process.platform with os.platform() ([#4822](https://github.com/ekovalets/node-mongodb-native/issues/4822)) ([c58ca1f](https://github.com/ekovalets/node-mongodb-native/commit/c58ca1f9d6a177470e58098ca1874174607c35c8))
* **NODE-7317:** use BSON.NumberUtils to determine endianness ([#4808](https://github.com/ekovalets/node-mongodb-native/issues/4808)) ([4e9467e](https://github.com/ekovalets/node-mongodb-native/commit/4e9467e8ab9ccbcf6eb47156d84ac538c5e3f6ea))
* **NODE-7319:** update allowed hosts list with *.mongo.com ([#4802](https://github.com/ekovalets/node-mongodb-native/issues/4802)) ([bfb7160](https://github.com/ekovalets/node-mongodb-native/commit/bfb71603fdfaaaebf418a3064f293d2c95697865))
* **NODE-7330:** deprecate RenameCollectionOptions.new_collection ([#4815](https://github.com/ekovalets/node-mongodb-native/issues/4815)) ([a96fa26](https://github.com/ekovalets/node-mongodb-native/commit/a96fa26dea3060828af747f0f2974229018de730))
* **NODE-7333:** add support for deprioritized servers to all topologies  ([#4821](https://github.com/ekovalets/node-mongodb-native/issues/4821)) ([a4211e7](https://github.com/ekovalets/node-mongodb-native/commit/a4211e77a30450ca8b162cbe3eec9f3759d3f517))


### Bug Fixes

* **NODE-7290:** use valueof for error code check ([#4791](https://github.com/ekovalets/node-mongodb-native/issues/4791)) ([1cc3d1c](https://github.com/ekovalets/node-mongodb-native/commit/1cc3d1c952274b2fc18ffd4898978af97f76b554))
* **NODE-7298:** ensure commonWireVersion is computed from server maxWireVersion ([#4805](https://github.com/ekovalets/node-mongodb-native/issues/4805)) ([2b2366d](https://github.com/ekovalets/node-mongodb-native/commit/2b2366dd18a76bd9e0b36b9911af6a0a317926c3))
* **NODE-7307:** Replace node:process.hrtime() with performance.now() ([#4816](https://github.com/ekovalets/node-mongodb-native/issues/4816)) ([ae2e037](https://github.com/ekovalets/node-mongodb-native/commit/ae2e037e896fbc673061da49a7c45743ae145651))
* **NODE-7308:** replace process.nextTick with queueMicrotask  ([#4817](https://github.com/ekovalets/node-mongodb-native/issues/4817)) ([b1b6e81](https://github.com/ekovalets/node-mongodb-native/commit/b1b6e81168a2cb6a2cc089d8c3cb83df1405931f))
...
* bump bson to 7.0.0-alpha.2 ([#4756](https://github.com/mongodb/node-mongodb-native/issues/4756)) ([9b34953](https://github.com/mongodb/node-mongodb-native/commit/9b3495359d4c87a26c33a2c2887c20d595e073e3))
...
* **NODE-4808:** remove support for stream() transform on cursors and change streams ([#4728](https://github.com/mongodb/node-mongodb-native/issues/4728)) ([1702987](https://github.com/mongodb/node-mongodb-native/commit/17029879712f9af4e941203deb636af612c02c62))
* **NODE-5510:** dont filter change stream options ([#4723](https://github.com/mongodb/node-mongodb-native/issues/4723)) ([a2daf76](https://github.com/mongodb/node-mongodb-native/commit/a2daf764d0a0a0be1d60727fdbdbf99e897e60aa))
...
* **NODE-6296:** remove cursor default batch size of 1000 ([#4729](https://github.com/mongodb/node-mongodb-native/issues/4729)) ([f8a855f](https://github.com/mongodb/node-mongodb-native/commit/f8a855fcfcd0a2a0314c1eee89a8cf40dddebac1))
...
* **NODE-6377:** remove noResponse option ([#4724](https://github.com/mongodb/node-mongodb-native/issues/4724)) ([9e9059a](https://github.com/mongodb/node-mongodb-native/commit/9e9059a82f4886748cbecc8d36045f4fef6a4015))
...
* **NODE-7046:** remove AWS uri/options support ([#4689](https://github.com/mongodb/node-mongodb-native/issues/4689)) ([d14ac3f](https://github.com/mongodb/node-mongodb-native/commit/d14ac3f66a7d17ece094568355a8e5b130c9926a))
...
* **NODE-7150:** update peer dependency matrix for 3rd party peer deps ([#4720](https://github.com/mongodb/node-mongodb-native/issues/4720)) ([0451dae](https://github.com/mongodb/node-mongodb-native/commit/0451dae9df3eaf3a0f85ac6e783a1da6bb31d1d3))
...
* **NODE-7259:** use alphas of all supporting packages ([#4746](https://github.com/mongodb/node-mongodb-native/issues/4746)) ([e1ea14c](https://github.com/mongodb/node-mongodb-native/commit/e1ea14ce80aece9d1cdd2e2c16ac1e5f4d9eff98))
...
* **NODE-7270:** remove extra BSONType file in docs/Next/variables ([#4754](https://github.com/mongodb/node-mongodb-native/issues/4754)) ([df3aaaa](https://github.com/mongodb/node-mongodb-native/commit/df3aaaa3480d19f82b4a0c265e4b9c4b6a69a94b))
